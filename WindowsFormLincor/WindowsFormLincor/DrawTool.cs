...
namespace WindowsFormLincor
{
    class DrawTool
    {
        ...
        public void DrawLin(Graphics g)
        {
            ...
            g.FillRectangle(blueBrush2, x + 60, y + 27, 10, 8);
            g.DrawLine(greenPen, x + 68, y + 28, x + 77, y + 22);
            if (n >= 2)
            {
                g.FillRectangle(blueBrush2, x + 75, y + 27, 10, 8);
                g.DrawLine(greenPen, x + 83, y + 28, x + 90, y + 22);
            }
            if (n >= 3)
            {
                g.FillRectangle(blueBrush2, x + 90, y + 27, 10, 8);
                g.DrawLine(greenPen, x + 98, y + 28, x + 105, y + 22);
            }
        }
    }
}
